...
def mock_send_email(mocker):
    mock = mocker.patch.object(EmailService, 'send_verification_email', return_value=None)
    return mock

# Test creating a user with valid data
async def test_create_user_with_valid_data(db_session, email_service, mock_send_email):
    user_data = {
...
async def test_register_user_with_valid_data(db_session, email_service, mock_send_email):
    user_data = {
